  ...
  <footer>
    <div className="footer-container" id="footer-bg">
      ...
      <nav className="elementi-footer">
        <a className="footer-icons" href="https://twitter.com/" target="_blank">
          <svg role="img" fill="#fff" width="32" height="32">
        ...
        <a className="footer-icons" href="https://github.com/" target="_blank">
          <svg fill="#fff" role="img" width="32" height="32">
        ...
        <a className="footer-icons" href="https://medium.com/" target="_blank">
          <svg role="img" fill="#fff" width="32" height="32">
